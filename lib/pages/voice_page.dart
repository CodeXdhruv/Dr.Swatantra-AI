...
//     widget.voiceService.recordingStream.listen((isRecording) {
//       if (mounted) {
//         setState(() {
//           _isActive = isRecording;
//           if (isRecording) {
//             _userTranscript = 'Recording... Speak now';
//             _aiResponse = '';
//             // Start wave animations
//             _waveController1.repeat();
//             _waveController2.repeat();
...
//             _pulseController.repeat(reverse: true);
//           } else {
//             _userTranscript = 'Processing...';
//             // Stop wave animations but keep processing state
//             _waveController1.stop();
//             _waveController2.stop();
//             _waveController3.stop();
//             _pulseController.stop();
...
//     widget.voiceService.playingStream.listen((isPlaying) {
//       if (mounted) {
//         setState(() {
//           _isProcessing = isPlaying;
//           if (!isPlaying && !widget.voiceService.isRecording) {
//             // Conversation cycle completed, add messages to chat
//             _addMessagesToChat();
//           }
//         });
//       }
...
//     widget.voiceService.statusStream.listen((status) {
//       if (mounted) {
//         // Update UI based on status if needed
//         if (status.contains('AI Text Response:')) {
//           // Extract AI response from status
//           final response = status.replaceFirst('AI Text Response: ', '');
//           setState(() {
...
//     // Add user message if we have transcript from the last recording
//     if (_userTranscript.isNotEmpty && 
//         _userTranscript != 'Recording... Speak now' && 
//         _userTranscript != 'Processing...') {
//       _chatMessages.add(
...
//     if (_isActive) {
//       widget.voiceService.stopPlayback();
//     }
...
//   void _startButtonRecording() async {
//     if (_isActive || _isProcessing) return;

//     final success = await widget.voiceService.startButtonRecording();
//     if (!success) {
//       // Handle error if needed
//       setState(() {
//         _userTranscript = 'Failed to start recording';
//       });
//     }
//   }

//   void _stopButtonRecordingAndProcess() async {
//     if (!_isActive) return;

//     final success = await widget.voiceService.stopButtonRecordingAndProcess();
//     if (!success) {
//       // Handle error if needed
//       setState(() {
//         _userTranscript = 'Failed to process recording';
//         _isActive = false;
//         _isProcessing = false;
//       });
...
//       builder: (context, child) {
//         return GestureDetector(
//           onTap: _isActive ? _stopButtonRecordingAndProcess : _startButtonRecording,
//           child: Transform.scale(
//             scale: _isActive ? _pulseAnimation.value : _breatheAnimation.value,
//             child: Container(
//               width: 100,
...
//           // Floating orbs
//           if (!_isActive && !_isProcessing) _buildFloatingOrbs(),
