  ...
  return (
    <div className="space-y-8 select-none font-ui">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="font-heading text-3xl font-bold text-primary-navy">Analytics Reports</h2>
          <p className="text-xs text-primary-navy/40 mt-1 font-light">Deep dive into app consumption, reads, downloads, and engagement metrics.</p>
        </div>
